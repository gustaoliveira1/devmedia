...
function main() {
    frase = escolherFrase()
    imprimirFraseDoDia(frase)
}

function escolherFrase() {
    let data_atual = new Date()
    let numero_sorteado = data_atual.getDate()
    let frase_de_hoje = frases_do_dia[numero_sorteado]
    return frase_de_hoje
}

function imprimirFraseDoDia(frase_de_hoje) {
    console.log("Frase do dia!")
    console.log("Mensagem: " + frase_de_hoje)
}
